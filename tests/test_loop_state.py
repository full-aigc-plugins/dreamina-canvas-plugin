...
LEGAL = {
    ...
    "TARGET_REGISTERED": {"DRAFT_SAVED", "STOPPED"},
    "DRAFT_SAVED": {"QUOTED", "STOPPED"},
    "QUOTED": {"AWAITING_APPROVAL", "PAUSED", "STOPPED"},
    "AWAITING_APPROVAL": {"SUBMITTED", "STOPPED"},
    "SUBMITTED": {"WAITING", "DRAINING_ACCEPTED", "FAILED"},
    "WAITING": {"ARTIFACT_VERIFIED", "DRAINING_ACCEPTED", "FAILED"},
    "ARTIFACT_VERIFIED": {"AWAITING_JUDGE", "FAILED"},
    "AWAITING_JUDGE": {"JUDGED", "FAILED"},

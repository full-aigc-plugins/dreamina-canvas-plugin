...
```bash
node scripts/bump-plugin.mjs dreamina-canvas patch   # 文档/注释/小修复
node scripts/bump-plugin.mjs dreamina-canvas minor   # 新功能
node scripts/bump-plugin.mjs dreamina-canvas major   # 破坏性变更
```
